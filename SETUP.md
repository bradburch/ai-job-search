...
```bash
# Bash / zsh / Git Bash
cd cv && lualatex "Brad Burch Resume - <Company> - <Role>.tex" && cd ..
cd cover_letters && xelatex "Brad Burch Cover Letter - <Company> - <Role>.tex" && cd ..
```

```powershell
# PowerShell
Set-Location cv; lualatex "Brad Burch Resume - <Company> - <Role>.tex"; Set-Location ..
Set-Location cover_letters; xelatex "Brad Burch Cover Letter - <Company> - <Role>.tex"; Set-Location ..
```
